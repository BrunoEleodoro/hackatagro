...
import 'package:hackatagro/services/app/auth_provider.dart';
import 'package:hackatagro/services/app/locale_provider.dart';
import 'package:hackatagro/services/cache/cache.dart';
import 'package:hackatagro/services/cache/cache_preferences.dart';
import 'package:hackatagro/services/cache/credential.dart';
...
import 'package:hackatagro/utils/firebase_analytics_provider.dart';
    ...
    MultiProvider(
      providers: <SingleChildWidget>[
        ...
        ChangeNotifierProvider<FirebaseAnalyticsProvider>(
            create: (BuildContext context) => FirebaseAnalyticsProvider()),
        ChangeNotifierProvider<LoginProvider>(
            create: (BuildContext context) =>
                LoginProvider(context.read<FirebaseAuthProvider>())),
